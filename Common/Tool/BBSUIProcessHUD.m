...
{
//    if (![BBSUIPostProcessHUD shareInstance].window)
//    {
//        [[BBSUIPostProcessHUD shareInstance] setup];
//    }
//    [BBSUIPostProcessHUD shareInstance].alertLabel.text = info;
//    [BBSUIPostProcessHUD shareInstance].backgroundView.backgroundColor = [UIColor greenColor];
