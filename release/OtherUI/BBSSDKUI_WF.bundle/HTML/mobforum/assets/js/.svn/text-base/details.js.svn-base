...
var details=new Vue({
	...
	created:function(){
		...
		this.$nextTick(function () {
			...
			$(document).on("click", "img[src_flag]", function(e){
				var imgList=[]
    ...
    methods:{
    	...
    	/*获得评论列表详情*/
    	getCommentList(fid, tid, page, pageSize,authorId){
    		var _this=this
    		var imgList=[]
