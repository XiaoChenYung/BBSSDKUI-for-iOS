...
- (void)configUI {
    ...
    [cancleBtn setTitleColor:[UIColor blueColor] forState:UIControlStateHighlighted];
    ...
    /**
     tableView
     */
//    _threadVC = [[BBSUIThreadListTableViewController alloc]initWithForum:nil selectType:BBSUIThreadSelectTypeLatest];
    _threadVC = [[BBSUIThreadListTableViewController alloc]initWithPageType:PageTypeSearch];
