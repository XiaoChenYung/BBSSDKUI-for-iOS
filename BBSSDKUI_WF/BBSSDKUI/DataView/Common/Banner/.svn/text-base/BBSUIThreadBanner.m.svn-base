...
#define KTitleLabelH 31
#define kMargin 15
#define kPageControlW 100
#define kPageControlH 25

@interface BBSUIThreadBanner () <UIScrollViewDelegate>
...
@implementation BBSUIThreadBanner
...
- (void)scrollViewClick:(UITapGestureRecognizer *)tap {
    ...
    if ([self.delegate respondsToSelector:@selector(bannerClick:)]) {
        ...
        [self.delegate bannerClick:self.currentImageIndex];
    }
}
...
//    [UIImage imageNamed:_picDataArray[self.currentImageIndex]];
    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:_picDataArray[self.currentImageIndex]] placeholderImage:[UIImage BBSImageNamed:@"/Home/bannerDefault@2x.png"]];
...
//    [UIImage imageNamed:_picDataArray[self.leftImageIndex]];
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:_picDataArray[self.leftImageIndex]] placeholderImage:[UIImage BBSImageNamed:@"/Home/bannerDefault@2x.png"]];
    
//    _rightImageView.image =
//    [UIImage imageNamed:_picDataArray[self.rightImageIndex]];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:_picDataArray[self.rightImageIndex]] placeholderImage:[UIImage BBSImageNamed:@"/Home/bannerDefault@2x.png"]];
...
- (void)setCycleViewStyle:(CycleViewStyle)cycleViewStyle {
    ...
    if (cycleViewStyle == CycleViewStyleNone) {
        ...
        _TitleFrame = CGRectMake((self.bounds.size.width - kTitleLabelW) / 2,
                                 ...
                                 self.bounds.size.width - kMargin - kMargin * 2, KTitleLabelH);
        ...
        _TitleFrame = CGRectMake(kMargin * 2, self.bounds.size.height - KTitleLabelH - kPageControlH,
                                 self.bounds.size.width - kMargin * 2 - kMargin * 4, KTitleLabelH);
...
{
    _mainScrollView.scrollEnabled = scrollEnabled;
}
