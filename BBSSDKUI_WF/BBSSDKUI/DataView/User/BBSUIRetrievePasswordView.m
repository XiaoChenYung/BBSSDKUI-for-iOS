...
//    }];
    ...
    self.contentView.layer.borderColor = DZSUIColorFromHex(0xD8D8D8).CGColor;
...
//    }];
    ...
    ({
        ...
        commitButton.backgroundColor = DZSUIColorFromHex(0x50A3D3);
        ...
        [commitButton mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.right.equalTo(self.contentView);
            make.top.equalTo(self.contentView.mas_bottom).offset(23);
...
- (void)commitButtonHandler:(UIButton *)button
{
    ...
    [BBSSDK resetPasswordWithEmail:self.emailTextField.text userName:self.userNameTextField.text token:nil result:^(NSError *error) {
