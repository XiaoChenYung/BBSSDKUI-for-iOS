...
- (void)configUI
{
    ...
    self.tableView =
    ({
        UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, DZSUIScreen_width, BBS_HEIGHT(self.view) - NavigationBar_Height) style:UITableViewStylePlain];
