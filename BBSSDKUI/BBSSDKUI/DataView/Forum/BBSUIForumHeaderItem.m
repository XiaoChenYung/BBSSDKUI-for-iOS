...
- (void)_configureUI
{
    ...
    _forumImageView.layer.cornerRadius = imageViewWidth / 2;
...
- (void)setForum:(BBSForum *)forum moreForumFlag:(BOOL)moreForumFlag result:(void (^)(BBSForum *))handler
{
    ...
    if (moreForumFlag) {
        ...
        if (forum.fid == 0) {
            ...
            [_forumImageView sd_setImageWithURL:[NSURL URLWithString:forum.forumPic] placeholderImage:[UIImage BBSImageNamed:@"/Forum/forumList3.png"]];
        }
    }
}
