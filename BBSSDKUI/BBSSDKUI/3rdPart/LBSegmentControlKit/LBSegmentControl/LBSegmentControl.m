...
- (void)initDefault {
    ...
    UIView *seperateView = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - 1, CGRectGetWidth(self.bounds), 1)];
    [seperateView setBackgroundColor:[UIColor colorWithRed:231/255.0 green:231/255.0 blue:231/255.0 alpha:1]];
...
- (void)addCtrlViewToScrollViewWithCtrlIndex:(NSInteger)ctrlIndex {
    ...
    // 设置子视图
    VC.view.frame = CGRectMake(ctrlIndex * LBkScreen_width, 0, LBkScreen_width, LBkScreen_height - NavigationBar_Height - self.origin.y - self.height);
