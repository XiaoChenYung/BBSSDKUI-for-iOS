...
- (BOOL)isLiked
{
    return [objc_getAssociatedObject(self, @"BBSThreadLikedKey") boolValue];
}

- (void)setIsLiked:(BOOL)isLiked
{
    objc_setAssociatedObject(self, @"BBSThreadLikedKey", @(isLiked), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
