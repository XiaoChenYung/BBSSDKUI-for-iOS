...
@implementation BBSUIRTETextStorage
...
- (void)applyStylesToRange:(NSRange)searchRange
{
    ...
    for (BBSUIRTEToken *attribute in self.tokens)
    {
...
{
    __block BBSUIRTEToken *attribute = nil;
    
    [self.tokens enumerateObjectsUsingBlock:^(BBSUIRTEToken *enumeratedAttribute, NSUInteger idx, BOOL *stop) {
