...
@implementation BBSUIRTETextView
...
{
    NSArray *solverTokens =  @[
                               [BBSUIRTEToken tokenWithName:@"html_tags"
                                            expression:@"(<\\/?[a-z][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(25, 0, 151)}],
                               [BBSUIRTEToken tokenWithName:@"a_tag"
                                            expression:@"(<\\/?[a][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(24, 104, 10)}],
                               [BBSUIRTEToken tokenWithName:@"img_tag"
                                            expression:@"(<\\/?[img][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(148, 0, 151)}],
                               [BBSUIRTEToken tokenWithName:@"html_entities"
