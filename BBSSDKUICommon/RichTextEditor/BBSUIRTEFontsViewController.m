...
@interface BBSUIRTEFontsViewController () <UITableViewDelegate,UITableViewDataSource> {
    
    BBSUIRTEFontFamily selectedFontFamily;
    
}

@end

@implementation BBSUIRTEFontsViewController

@synthesize delegate;

#pragma mark - Init Section
+ (BBSUIRTEFontsViewController *)cancelableFontPickerViewControllerWithFontFamily:(BBSUIRTEFontFamily)fontFamily {
    return [[BBSUIRTEFontsViewController alloc] initWithFontFamily:fontFamily];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:
        selectedFontFamily = BBSUIRTEFontFamilyDefault;
        break;
        
        case 1:
        selectedFontFamily = BBSUIRTEFontFamilyTrebuchet;
        break;
        
        case 2:
        selectedFontFamily = BBSUIRTEFontFamilyVerdana;
        break;
        
        case 3:
        selectedFontFamily = BBSUIRTEFontFamilyGeorgia;
        break;
        
        case 4:
        selectedFontFamily = BBSUIRTEFontFamilyPalatino;
        break;
        
        case 5:
        selectedFontFamily = BBSUIRTEFontFamilyTimesNew;
        break;
        
        case 6:
        selectedFontFamily = BBSUIRTEFontFamilyCourierNew;
        break;
