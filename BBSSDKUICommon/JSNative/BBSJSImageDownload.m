...
- (void)setURL:(NSString *)urlStr imageData:(NSData *)imageData isImageViewer:(BOOL)isImageViewer
{
    ...
    [self nativeShowImage:index url:[NSString bbs_md5:urlStr] imgSrc:filePath isImageViewer:isImageViewer];
}
...
-(void)saveImageWithUrl:(NSString *)imageURL{
    ...
    // 拿到沙盒路径图片
    UIImage *imgFromUrl3=[[UIImage alloc]initWithContentsOfFile:ImagePath([NSString bbs_md5:imageURL])];
    // 图片保存相册
