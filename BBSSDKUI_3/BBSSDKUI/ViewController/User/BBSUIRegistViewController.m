...
@property (nonatomic, strong) BBSUIButton *registBtn;
...
- (void)configUI
{
    ...
    ({
        ...
        [usernameTextField mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(_registBackGround).offset(0);
            make.right.equalTo(_registBackGround).offset(0);
    ...
    ({
        ...
        [emailTextField setFont:[UIFont systemFontOfSize:14]];
    ...
    line3.backgroundColor = DZSUIColorFromHex(0xECECEC);
    [_registBackGround addSubview:line3];
    ...
    ({
        ...
        BBSUIButton *registBtn = [[BBSUIButton alloc] initWithFrame:CGRectMake(0, 0, DZSUIScreen_width - 100, 45) FromColorArray:colors ByGradientType:leftToRight];
