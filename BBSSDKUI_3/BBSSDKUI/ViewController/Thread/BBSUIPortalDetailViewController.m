...
#pragma mark -- xxxxxx
        ...
        if (!error) {
            ...
            //=====喜欢加+1
#pragma mark --论坛喜欢用的是recommend_add 资讯的喜欢用的是click1   坑啊~~~~~
            NSLog(@"-----xxxx--000--%ld", (long)_threadModel.recommend_add);
            _threadModel.click1 =  _threadModel.click1  + 1;
            [[BBSUICoreDataManage shareManager] addHistoryWithThread:_threadModel];
            NSLog(@"-----xxxx--111--%ld", (long)_threadModel.recommend_add);
        }
        else
        {
