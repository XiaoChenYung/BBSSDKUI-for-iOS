...
{
    BBSUIPopoverView *orderBBSUIPopoverView = [BBSUIPopoverView popoverView];
    orderBBSUIPopoverView.showShade = YES; // 显示阴影背景
    orderBBSUIPopoverView.selectType = self.currentSelectType;
    orderBBSUIPopoverView.orderIndex = self.currentOrderType;
    orderBBSUIPopoverView.isFashion = YES;
    [orderBBSUIPopoverView showToView:sender withActions:[self orderTypeActions] button:sender];
}
