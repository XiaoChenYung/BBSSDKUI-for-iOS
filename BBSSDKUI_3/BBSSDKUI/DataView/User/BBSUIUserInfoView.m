...
- (void)configureUI
{
    ...
    [self.avatarImageView setImage:[UIImage BBSImageNamed:@"/User/AvatarDefault3.png"]];
...
//            [activeButton.layer setBorderWidth:0.5];
            if ([self.currentUser.emailStatus integerValue] == 1) {
                ...
                [activeButton setTitleColor:DZSUIColorFromHex(0xFF3500) forState:UIControlStateNormal];
