...
- (void)setCollection:(BBSThread *)collection
{
    ...
    _timeLabel.text = [NSString bbs_timeTextWithTimesStamp:collection.createdOn];
    if (collection.aid)
    {
        _timeLabel.text = [NSString bbs_timeTextWithTimesStamp:collection.dateline];
    }
...
- (void)setFrameForFavorites:(BBSThread *)collection
{
    ...
    if(collection.images.count || collection.pic)
    {
        ...
        [_imagesView mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(@24);
            make.bottom.equalTo(@(hasAddress?-50:-24));
        ...
        [_repliesLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self.contentView).offset(hasAddress?-43:-17).priorityHigh();
            make.height.equalTo(@10);
        }];
    }
    else
    {
        ...
        [_repliesLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self.lineView).offset(hasAddress?-43:-17).priorityHigh();
            make.height.equalTo(@10);
        }];
    }
...
- (void)setFrameForUserThread:(BBSThread *)collection
{
    ...
    if(collection.images.count || collection.pic)
    {
        ...
        [_imagesView mas_remakeConstraints:^(MASConstraintMaker *make) {
            make.width.height.equalTo(@95);
            make.top.equalTo(@24);
            make.bottom.equalTo(_lineView.mas_top).offset(hasAddress?-50:-24);
            make.right.equalTo(@-20);
        }];
