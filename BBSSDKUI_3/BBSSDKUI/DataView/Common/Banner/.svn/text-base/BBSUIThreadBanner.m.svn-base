...
//    [UIImage imageNamed:_picDataArray[self.leftImageIndex]];
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:_picDataArray[self.leftImageIndex]] placeholderImage:[UIImage BBSImageNamed:@""]];
    
//    _rightImageView.image =
//    [UIImage imageNamed:_picDataArray[self.rightImageIndex]];
    [_rightImageView sd_setImageWithURL:[NSURL URLWithString:_picDataArray[self.rightImageIndex]] placeholderImage:[UIImage BBSImageNamed:@""]];
...
{
    [self.mainScrollView setScrollEnabled:scrollEnabled];
}
